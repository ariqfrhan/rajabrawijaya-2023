        ...
        <div className="absolute inset-0">
          <div className="container mx-auto relative flex flex-col h-full lg:flex-row lg:items-center">
            <div className="relative z-20">
              ...
              <p className="font-esthetique text-white text-xl mt-3 md:text-3xl">Rangkaian Acara Jelajah Almamater Universitas Brawijaya</p>
            </div>
            <img src="/assets/images/NAGA_1.png" className="z-10 absolute top-32 md:top-36 lg:top-40 lg:left-16 "></img>
          </div>
        </div>
        <img src="/assets/images/awan_atas.png" className="w-full object-cover absolute lg:-bottom-20 -bottom-1 mb-10"></img>
      </div>
    </>
  );
}
